/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 78d3591c90e967773006ac332f6cd4d0)
...
declare namespace Cloudflare {
	interface Env {
		...
		API_ACCESS_CONTROL_ALLOW_ORIGIN: string;
		EMAIL_FROM: string;
		EMAIL_SMTP_HOST: string;
		EMAIL_SMTP_PORT: string;
		EMAIL_SMTP_SECURE: string;
		EMAIL_SMTP_AUTH_USER: string;
		EMAIL_SMTP_AUTH_PASSWORD: string;
