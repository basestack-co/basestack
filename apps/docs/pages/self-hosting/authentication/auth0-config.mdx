---
title: Basestack Platform - Auth0 Configuration Guide
description: Authentication through Auth0 allows for more granular control over authentication aspects.
tags: Basestack, Auth0, Configuration Guide, Authentication, Rules, Account Creation, Credentials, Email, Password, Granular Control, Auth0 Configuration, Auth0 Application Settings, Self-Hosting Environment Variables
---
