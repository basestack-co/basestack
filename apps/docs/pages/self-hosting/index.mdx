...
Because the Basestack Platform uses background jobs to handle tasks such as sending emails, you need to configure the following environment variables:
...
The Basestack Platform uses [LemonSqueezy ↗](https://www.lemonsqueezy.com/) for payments. To configure [LemonSqueezy ↗](https://www.lemonsqueezy.com/), set the following environment variables:
