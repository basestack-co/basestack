---
title: Basestack Platform - Deploy to Netlify
...
<Callout type="info" emoji="ℹ️">
  ...
  the [Troubleshooting
  section](/self-hosting/providers/deploy-netlify#troubleshooting) for further
  assistance.
</Callout>
...
To ensure a successful deployment on Netlify, the platform requires a minimum set of environment variables. Below is the list of environment variables that you must fill in. For the complete list of Environment Variables, please refer to the [Configuration Page](/self-hosting#environment-variables).
