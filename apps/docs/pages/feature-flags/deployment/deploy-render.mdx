...
#### Guide to Retrieve the `DATABASE_URL`
...
Note: The provided connection string is just an example. Please ensure you use the one you generated with your specific details.
