...
Copy this URL and update the information in your Github [OAuth App](https://github.com/settings/developers). Next, modify the environment variables in the project settings on Vercel and initiate a new deployment on Vercel once again.
