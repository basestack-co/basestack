...
By clicking on the button above, a new repository will be created in your Git account (e.g., GitHub) from the [Basestack Platform](https://github.com/basestack-co/basestack) repository, and the platform will be deployed for you. This will be an independent copy with no connection to the main project.
