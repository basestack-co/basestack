...
<Callout type="info" emoji="ℹ️">
  ...
  [Webpack](https://webpack.js.org/?ref=basestack.co) or [Rollup](https://rollupjs.org/?ref=basestack.co) to
  bundle your code.
</Callout>
...
In a server environment like Node or Serverless, you can use the SDK as usual because it utilizes the Fetch API, which is supported in Node.js.
