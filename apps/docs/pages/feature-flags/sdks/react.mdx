...
<FileTree>
  <FileTree.Folder name="src" defaultOpen>
    <FileTree.Folder name="libs" defaultOpen>
      <FileTree.Folder name="feature-flags" defaultOpen>
        <FileTree.Folder name="hooks" defaultOpen>
          <FileTree.File name="useFlag.tsx" />
          <FileTree.File name="useFlags.tsx" />
...
```ts copy filename="src/pages/api/hello.ts"
...
```tsx copy filename="src/app/count/page.tsx"
import { ServerFlagsSDK } from "@/libs/feature-flags/server";
...
```tsx copy filename="src/app/posts/page.tsx"
"use client";
