---
title: Basestack Forms - NextJS & React Integration
description: Learn how to integrate Basestack Forms with your React or Next.js project. Use the Fetch API, Axios, or any HTTP client to send form data and handle submissions in a dynamic, scalable application.
...
[React](https://react.dev/) is a JavaScript library for building user interfaces, allowing developers to create interactive, dynamic web applications with reusable components. [Next.js](https://nextjs.org/) is a React framework that enables server-side rendering, static site generation, and simplified routing for building fast, scalable web applications.
