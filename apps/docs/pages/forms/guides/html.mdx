---
title: Basestack Forms - HTML Integration
description: Learn how to integrate Basestack Forms with your HTML form by updating the form action, assigning name attributes to fields, and submitting data to the Basestack API. Follow the steps to get started with seamless form submissions.
...
[HTML](https://developer.mozilla.org/en-US/docs/Web/HTML) (HyperText Markup Language) is the standard markup language used to structure content on the web. It defines the elements and layout of a webpage, such as headings, paragraphs, images, links, and more, providing the foundation for web development.
