---
title: Basestack Forms - Vue Integration
description: Learn how to integrate Basestack Forms with your Vue.js project. Use the Fetch API, Axios, or any HTTP client to send form data and handle submissions in your Vue component.
...
[Vue.js](https://vuejs.org/) is a progressive JavaScript framework for building user interfaces, designed to be approachable, versatile, and easy to integrate, with a focus on declarative rendering and component-based architecture.
