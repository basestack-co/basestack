---
title: Basestack Forms - Spam Protection
description: Basestack Forms uses various spam protection techniques, including AI models and methods like Honeypot and IP blocking, to identify and streamline the review of spam submissions. Learn how these features help keep your forms secure and efficient.
...
<Callout type="info" emoji="ℹ️">
    Rather than deleting spam submissions, we simply mark them as spam. The focus of our spam protection is not to
    decrease the number of spam submissions, but to streamline your review of submissions on the dashboard.
</Callout>


## Methods to Protect Against Spam

We use AI models to identify spam to the best of our ability, but there may still be instances where some submissions slip through. You may also want to block specific types of [bots](https://en.wikipedia.org/wiki/Internet_bot) from submitting any data.
