---
title: Basestack Forms - Deploy to Vercel
...
<Callout type="info" emoji="ℹ️">
  ...
  the [Troubleshooting section](/forms/deployment/deploy-vercel#troubleshooting)
...
"Authorization callback URL": "https://your-basestack-forms-instance.com/api/auth/callback/github"
```
...
To ensure a successful deployment on Vercel, the platform requires a minimum set of environment variables. Below is the list of environment variables that you must fill in. For the complete list of Environment Variables, please refer to the [Configuration Page](/forms/deployment#environment-variables).
...
<Callout type="info" emoji="ℹ️">
  ...
  guidance to ensure a successful and seamless deployment of the Forms
  Platform.
</Callout>
