...
essentially act as a wrapper for our [JavaScript SDK](/docs/feature-flags/sdks/javascript). Instead, we’ll show you
...
For details regarding the initialization options of @basestack/flags-js, please refer to the documentation related to the [Javascript SDK](/docs/feature-flags/sdks/javascript#initialisation-options).
