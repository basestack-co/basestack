...
<Callout type="info">
  ...
  deploy, refer to the [How to
  Contribute](/content/self-hosting/contributing#getting-started) page for
  instructions on running the platform locally. This will allow you to explore
  and evaluate the changes before making any deployment decisions.
</Callout>
