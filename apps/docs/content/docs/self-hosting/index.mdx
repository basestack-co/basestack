...
<Cards>
  <Card title="Vercel" href="/docs/self-hosting/providers/deploy-vercel" >
  ...
  <Card title="Netlify" href="/docs/self-hosting/providers/deploy-netlify" >
      Netlify lets you easily deploy Next.js apps with serverless functions and continuous deployment from Git.
  </Card>
  <Card title="Render" href="/docs/self-hosting/providers/deploy-render" >
...
- [Github Configuration](/docs/self-hosting/authentication/github-config)
- [Google Configuration](/docs/self-hosting/authentication/google-config)
