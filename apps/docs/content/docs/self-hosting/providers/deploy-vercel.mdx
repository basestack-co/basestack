...
<Callout type="warning">
  ...
  details, refer to the [Getting Updates Page](/docs/self-hosting/updates).
</Callout>
...
- [Neon - Serverless Postgres](/docs/self-hosting/database/neon)
...
<Callout type="info">
  ...
  the [Troubleshooting
  section](/docs/self-hosting/providers/deploy-vercel#troubleshooting) for further
  assistance.
</Callout>
...
To ensure a successful deployment on Vercel, the platform requires a minimum set of environment variables. Below is the list of environment variables that you must fill in. For the complete list of Environment Variables, please refer to the [Configuration Page](/docs/self-hosting#environment-variables).
...
Lastly, stay tuned about updates, including new features and bug fixes. To ensure your platform is always up-to-date with the latest improvements, refer to our guide on updating the platform by visiting the [Updates Page](/docs/self-hosting/updates).

<Callout type="info">
  For more comprehensive information about the deployment process, please check
  out the [Configuration Page](/docs/self-hosting). This page provides detailed
