...
<Callout type="info">
  ...
  the [Troubleshooting
  section](/docs/self-hosting/providers/deploy-netlify#troubleshooting) for further
  assistance.
</Callout>
...
Page](/docs/self-hosting/updates).
...
To ensure a successful deployment on Netlify, the platform requires a minimum set of environment variables. Below is the list of environment variables that you must fill in. For the complete list of Environment Variables, please refer to the [Configuration Page](/docs/self-hosting#environment-variables).
